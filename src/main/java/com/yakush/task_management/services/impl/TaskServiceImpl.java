package com.yakush.task_management.services.impl;

import com.yakush.task_management.dto.comment.CommentDto;
import com.yakush.task_management.dto.comment.CommentDtoConverter;
...
import com.yakush.task_management.services.CommentService;
import com.yakush.task_management.services.TaskService;
...
public class TaskServiceImpl implements TaskService {
    ...
    public TaskDto updateTaskStatusById(Long id, Integer taskStatusValue, User authorOrAssignee) {
        ...
        if (!task.getAuthor().equals(authorOrAssignee) && !task.getAssignees().contains(authorOrAssignee)) {
            throw new IllegalArgumentException("Only the author or assignee can update the task status!");
        }
